...
<!--end of carousel-->
	...
	<p><br>The Chocolate Room is the first room shown in Willy Wonka's factory. The whole room is made to resemble a chocolate room, except made entirely out of candy. The centerpiece of the room is Candy, which is incredibly important to the making of any chocolate candies in the factory<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
    ...
    <h3 class="text-center"><br>Gallery<br><br></h3>
        <div class="d-flex flex-row flex-wrap justify-content-center">
           <div class="d-flex flex-column">
              <img src="img/shake.jpg" class="img-fluid">
...
?>
            ...
            <p class="text-right">Chocolate Room <br><i class="fa fa-map-marker"></i>&nbsp; Sec.4,Hiran Magri <br>Udaipur <br><br>E-mail: info@Gmail.com<br>phone: +9252346783</p>
            </div>
